		...
		'factory': factory.BuildFactory(
			[
				...
				factory.s(step.Test,
					command = \
						'call ..\\..\\..\\dev-pack && ' +
						'set PATH=%PATH%;%CD%\\++packageneric\\variants\\default\\stage-install\\usr\\local\\lib && ' + 
						'.\\++packageneric\\variants\\default\\stage-install\\usr\\local\\bin\\psycle-helpers_unit_tests --log_level=test_suite --report_level=detailed',
					locks = [compile_lock])
			]
		)
	}
