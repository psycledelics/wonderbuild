...
BuildmasterConfig['builders'].append(
	{
		...
		'factory': factory.BuildFactory(
			[
				...
				factory.s(step.Compile, command = 'cd psycle-core && qmake -recursive && make', locks = [compile_lock]),
			]
		)
	}
)
...
BuildmasterConfig['builders'].append(
	{
		...
		'factory': factory.BuildFactory(
			[
				...
				factory.s(step.Compile, command = 'call ..\\..\\..\\dev-pack && cd psycle-core && qmake -recursive && mingw32-make', locks = [compile_lock])
			]
		)
	}
)
...
BuildmasterConfig['builders'].append(
	{
		...
		'factory': factory.BuildFactory(
			[
				...
				factory.s(step.Compile, command = 'cd psycle-player && qmake -recursive && make', locks = [compile_lock])
			]
		)
	}
)
...
BuildmasterConfig['builders'].append(
	{
		...
		'factory': factory.BuildFactory(
			[
				...
				factory.s(step.Compile, command = 'call ..\\..\\..\\dev-pack && cd psycle-player && qmake -recursive && mingw32-make', locks = [compile_lock])
			]
		)
	}
)
...
BuildmasterConfig['builders'].append(
	{
		...
		'factory': factory.BuildFactory(
			[
				...
				factory.s(step.Compile, command = 'cd qpsycle && qmake -recursive && make', locks = [compile_lock])
			]
		)
	}
)
...
BuildmasterConfig['builders'].append(
	{
		...
		'factory': factory.BuildFactory(
			[
				...
				factory.s(step.Compile, command = 'call ..\\..\\..\\dev-pack && cd qpsycle && qmake -recursive && mingw32-make', locks = [compile_lock])
			]
		)
	}
)
