...
TARGET = pooplog_filter
TEMPLATE = lib

DEFINES += pooplog_filter_built

SOURCES += ../src/psycle/plugins/pooplog_filter/pooplog_filter.cpp\
../src/psycle/plugins/pooplog_filter/filter.cpp\

HEADERS += ../src/psycle/plugins/pooplog_filter/filter.h\
