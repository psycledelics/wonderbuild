...
TARGET = arguru_synth_2_final
TEMPLATE = lib

DEFINES += arguru_synth_2_final_built

SOURCES += ../src/psycle/plugins/arguru_synth_2_final/arguru_synth_2_final.cpp\
    ../src/psycle/plugins/arguru_synth_2_final/filter.cpp\
    ../src/psycle/plugins/arguru_synth_2_final/SynthTrack.cpp\

HEADERS += ../src/psycle/plugins/arguru_synth_2_final/filter.hpp\
        ../src/psycle/plugins/arguru_synth_2_final/SynthTrack.hpp\
