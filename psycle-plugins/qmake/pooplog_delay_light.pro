...
TARGET = pooplog_delay_light
TEMPLATE = lib

DEFINES += pooplog_delay_light_built

SOURCES += ../src/psycle/plugins/pooplog_delay_light/pooplog_delay.cpp\
../src/psycle/plugins/pooplog_delay_light/filter.cpp\
