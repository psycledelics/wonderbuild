...
TARGET = pooplog_synth_light
TEMPLATE = lib

DEFINES += pooplog_synth_light_built

SOURCES += ../src/psycle/plugins/pooplog_synth_light/pooplog_synth.cpp\
../src/psycle/plugins/pooplog_synth_light/filter.cpp\
../src/psycle/plugins/pooplog_synth_light/SynthTrack.cpp\
