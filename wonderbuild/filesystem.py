...
class Node(object):
	...
	def _do_stat(self):
		...
		# note: Unlike mtime, ctime is updated when a change in perm or ownership occurs.
		# note: We don't use ctime because it is also updated when making a hard link.
