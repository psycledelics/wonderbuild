...
def wonderbuild_no_yield_script(project):

	from wonderbuild_no_yield.cxx_chain import UserCfg, PkgConfigCheckTask, BuildCheckTask, PreCompileTask, ModTask
	from wonderbuild_no_yield.std_checks import StdMathCheckTask
