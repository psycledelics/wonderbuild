...
psycle-plugins/wonderbuild_script.py --install-dest-dir=/ --install-prefix-dir=$dest --cxx-flags='-O2 -ggdb3 -DNDEBUG -Wall' &&
psycle-player/wonderbuild_script.py  --install-dest-dir=/ --install-prefix-dir=$dest --cxx-flags='-O2 -ggdb3 -DNDEBUG -Wall' &&
