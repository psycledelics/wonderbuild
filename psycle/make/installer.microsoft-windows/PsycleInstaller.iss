...
Name: {userappdata}\psycle\; Type: filesandordirs; Components: Application
[_ISToolDownload]
Source: http://heanet.dl.sourceforge.net/project/psycle/psycle/1.8.5/psycle-1.8.5-vst-bundle.exe; DestDir: {tmp}; DestName: Vst-Bundle.exe; Components: VstPack; Languages: 
Source: http://download.microsoft.com/download/2/d/6/2d61c766-107b-409d-8fba-c39e61ca08e8/vcredist_x64.exe; DestDir: {tmp}; DestName: vcredist_x64.exe; Components: " InstallMSRuntimes InstallMSRuntimes_x64"; Languages: 
Source: http://download.microsoft.com/download/d/d/9/dd9a82d0-52ef-40db-8dab-795376989c03/vcredist_x86.exe; DestDir: {tmp}; DestName: vcredist_x86.exe; Components: " InstallMSRuntimes InstallMSRuntimes_x86"; Languages: 
[Code]
