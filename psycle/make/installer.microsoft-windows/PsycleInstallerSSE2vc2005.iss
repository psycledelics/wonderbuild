...
[Files]
Source: ..\msvc_8.0\output\release\bin\psycle.exe; DestDir: {app}; Flags: ignoreversion; Tasks: ; Languages: ; Components: Application
Source: ..\msvc_8.0\output\release\bin\boost_filesystem-vc80-mt-1_33_1.dll; DestDir: {app}; Flags: ignoreversion; Components: Application; Tasks: ; Languages: 
Source: ..\msvc_8.0\output\release\bin\boost_thread-vc80-mt-1_33_1.dll; DestDir: {app}; Flags: ignoreversion; Components: Application
Source: ..\msvc_8.0\output\release\bin\universalis.dll; DestDir: {app}; Flags: ignoreversion; Components: Application
Source: ..\msvc_8.0\output\release\bin\psycle.plugins\*.dll; DestDir: {app}\PsyclePlugins; Flags: ignoreversion; Components: Open_Source_Plugins; Excludes: crasher.dll
...
Source: C:\Archivos de programa\Microsoft Visual Studio 8\SDK\v2.0\BootStrapper\Packages\vcredist_x86\vcredist_x86.exe; DestDir: {tmp}; DestName: vcredist_x86.exe; Flags: deleteafterinstall ignoreversion replacesameversion; Components: Application
